        ...
        <main className="max-w-4xl mx-auto px-6 py-10 space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[#414845] text-sm mt-1 font-label">Import and manage your organisation&apos;s privacy and redaction policies.</p>
            </div>
            <button
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-[#c1c8c4]/30 rounded-2xl">
              <Shield className="w-12 h-12 text-[#414845]/20 mb-4" />
              <h3 className="font-bold text-[#191c1a] mb-1">No policies yet</h3>
              <p className="text-sm text-[#414845]/60 font-label text-center max-w-xs">Import your company&apos;s privacy or redaction rules using the &ldquo;Add Policy&rdquo; button above.</p>
            </div>
          ) : (
